...
const SingleCombo = () => {
    ...
    const gunA_ComboList = [{ id: '2a', name: 'Combo 2a' }];
    const gunB_ComboList = [{ id: '2b', name: 'Combo 2b' }];
    ...
    const styles = {
        ...
        tableContainer: { flex: 1, display: "flex", flexDirection: "column", borderBottom: `2px solid ${themeColor}` },
    ...
    return (
        <div style={styles.container}>
            ...
            <div style={styles.header}><span style={styles.modeLabel}>Selected Mode: Single Combo</span></div>
