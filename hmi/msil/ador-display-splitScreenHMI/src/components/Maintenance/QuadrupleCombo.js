...
const QuadrupleCombo = () => {
    ...
    const gunA_ComboList = [{ id: '1a', name: 'Combo 1a' }, { id: '2a', name: 'Combo 2a' }, { id: '3a', name: 'Combo 3a' }, { id: '4a', name: 'Combo 4a' }];
    const gunB_ComboList = [{ id: '1b', name: 'Combo 1b' }, { id: '2b', name: 'Combo 2b' }, { id: '3b', name: 'Combo 3b' }, { id: '4b', name: 'Combo 4b' }];
    ...
    const s = {
        ctr: { padding: "1rem 2rem", fontFamily: "'Segoe UI', sans-serif", backgroundColor: "#1a1a2e", minHeight: "calc(100vh - 80px)", maxHeight: "calc(100vh - 80px)", overflowY: "auto" },
        fm: { textAlign: "center", color: "#ff6b6b", fontSize: "1.2rem", fontWeight: "600", padding: "0.75rem", marginBottom: "1rem", background: "linear-gradient(135deg, rgba(220, 38, 38, 0.2), rgba(220, 38, 38, 0.3))", borderRadius: "8px", border: "2px solid rgba(220, 38, 38, 0.5)", animation: "flash 2s infinite" },
        hdr: { display: "flex", justifyContent: "flex-end", marginBottom: "1rem" },
        ml: { fontSize: "1.1rem", fontWeight: "600", color: tc, background: `linear-gradient(135deg, rgba(${rgb}, 0.2), rgba(${rgb}, 0.3))`, padding: "0.5rem 1.5rem", borderRadius: "20px", border: `2px solid ${tc}` },
        gc: { display: "flex", gap: "1.5rem", height: "calc(100vh - 200px)" },
        gp: { flex: 1, background: "#16213e", border: `2px solid ${tc}`, display: "flex", flexDirection: "column", overflow: "hidden", borderRadius: "8px" },
        ...
        sh: { fontSize: "0.95rem", fontWeight: "700", color: "#fff", textTransform: "uppercase", letterSpacing: "1px", padding: "0.6rem 1rem", background: `rgba(${rgb}, 0.5)`, borderBottom: `2px solid ${tc}` },
        tr: { display: "flex", justifyContent: "space-between", alignItems: "center", padding: "0.75rem 1rem", borderBottom: `1px solid rgba(${rgb}, 0.3)`, backgroundColor: "#16213e" },
        tra: { display: "flex", justifyContent: "space-between", alignItems: "center", padding: "0.75rem 1rem", borderBottom: `1px solid rgba(${rgb}, 0.3)`, backgroundColor: "#1a1a2e" },
        tl: { fontSize: "1rem", fontWeight: "500", color: "#e0e0e0" },
        ...
        tcir: { width: "22px", height: "22px", borderRadius: "50%", backgroundColor: "#fff", position: "absolute", top: "3px", boxShadow: "0 2px 4px rgba(0,0,0,0.4)" },
    };

    const gts = (a) => ({ ...s.tb, backgroundColor: a ? tc : "#4a5568" });
    const gtcs = (a) => ({ ...s.tcir, left: a ? "27px" : "3px" });
    const gss = (a, t) => ({ ...s.ts, color: t === "on" ? (a ? tc : "#718096") : (!a ? "#a0aec0" : "#718096") });
    ...
    return (
        <div style={s.ctr}>
            ...
            <div style={s.hdr}><span style={s.ml}>Selected Mode: Quadruple Combo</span></div>
            <div style={s.gc}>
